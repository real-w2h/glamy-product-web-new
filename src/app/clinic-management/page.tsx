  ...
  const benefits = [
    {
      ...
      text: "Operational excellence achieve karein"
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-green-500" />,
      text: "Better patient experience provide karein"
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-green-500" />,
      text: "Digital clinic management"
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-green-500" />,
      text: "All-in-one solution for clinic owners"
    }
  ];
          ...
          <div className="max-w-6xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">
                ⚕️ Clinic Management, Simplified with Glame CRM
              </h1>
            </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-3">
                        {index === 0 ? '🗓️' : index === 1 ? '🗂️' : index === 2 ? '🔔' : '📊'} {feature.title}:
                      </h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-green-50 p-12 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
              <div className="flex items-center justify-center mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-800 animate-bounce">
                  👉 Apni clinic ko digital banayein, Glame CRM ke saath
                </h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Smart Records</h3>
